...
#'  
#' l5 <- tcplLoadData(lvl = 5, fld = "aeid", val = 10)
#' l4_agg <- tcplLoadData(lvl = "agg", fld = "aeid", val = 10)
#' l6 <- tcplLoadData(lvl = 6, fld = "aeid", val = 10)
#' \dontrun{
...
#' bpa <- tcplLoadChem(field = "chnm", val = "chromium")[ , spid]
...
tcplPlotFits <- function(dat, agg, flg=NULL, ordr.fitc=FALSE, bline="bmad") {

...
#-------------------------------------------------------------------------------
# gtoxWriteLvl0: Write level 0 screening data into the gtox databases
#-------------------------------------------------------------------------------

#' @title Write level 0 screening data into the gtox databases
#'
#' @description
#' \code{gtoxWriteLvl0} takes a data.table with level 0 screening data and
#' writes the data into the level 0 tables in the gtox databases.
#'
...
#' gtox chemical database. If field types get changed a warning is given
#' listing the affected fields and they type they were coerced to. If the
#' acsn(s) or spid(s) do not map to the gtox databases the function will return
...
gtoxWriteLvl0 <- function(dat, type) {

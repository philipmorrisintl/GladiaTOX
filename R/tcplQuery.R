...
#-------------------------------------------------------------------------------
# tcplQuery: Query the gtox databases
#-------------------------------------------------------------------------------

#' @title Wrapper for sending queries and fetching results
#'
#' @description
#' These functions send a query to the given database
#' 
#' @param query Character of length 1, the query string
#' @param tbl Added for compatibility with tcpl last version
#' @inheritParams tcplConf
#'
#' @examples
#' qformat <- "SELECT * FROM assay_source"
#' tcplQuery(qformat)
#'
#' @import DBI

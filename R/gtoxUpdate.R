...
#-------------------------------------------------------------------------------
# gtoxUpdate: Update assay or chemical information
#-------------------------------------------------------------------------------
...
gtoxUpdate <- function(what, id, flds) {
    ...
    pot_flds <- gtoxListFlds(tbl=i[[1]], db=getOption("TCPL_DB"))
